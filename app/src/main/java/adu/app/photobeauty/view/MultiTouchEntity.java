...
public abstract class MultiTouchEntity implements Serializable {
	private final static float MIN_SCALE = 0.1f, MAX_SCALE = 5f;
	...
	protected boolean mIsDragOverOther = false;
	...
	protected boolean setPos(float centerX, float centerY, float scaleX,
		...
		if (scaleX < MIN_SCALE || scaleX > MAX_SCALE || scaleY < MIN_SCALE
				|| scaleY > MAX_SCALE)
			return false;
	...
	public boolean getIsFocus(boolean b) {
		// TODO Auto-generated method stub
		return mFocus;
	}
